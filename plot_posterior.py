...
chain_fname = f'{filebase}/mcmc_chain_v{version}_{compression_hash}.npz'
...
fig.savefig(f'{filebase}/mcmc_chain_v{version}_{compression_hash}.pdf', bbox_inches='tight')
